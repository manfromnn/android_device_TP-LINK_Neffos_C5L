...
static void export_kernel_boot_props(void)
{
    ...
    else if (!strcmp(bootmode,"ftmtestmode"))
        property_set("ro.ftmtestmode", "1");
    /* Added by yanwenlong for ftm mode. (general) 2013.7.31 end */
    /* Added by yanwenlong for ffbm. (general) 2014-9-2 begin */
    else if (!strcmp(bootmode, "ffbm-01"))
        property_set("ro.bootmode", "ffbm-01");
    /* Added by yanwenlong for ffbm. (general) 2014-9-2 end */
    else
...
int main(int argc, char **argv)
{
    ...
    if (is_charger) {
    /*modified by litao*/
        action_for_each_trigger("charger-svc", action_add_queue_tail);
