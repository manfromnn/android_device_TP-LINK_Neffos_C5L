...
// Added by yanwenlong for data_bk. (QL1700). 2014-11-26
#define SVC_EMERGENCY   0x400 /* will try data-recovery if keeps crashing */
...
void stop_main_service(void); // Added by yanwenlong for data_bk. (QL1700). 2014-7-28
