...
###FineOS start
ifeq ($(strip $(HQ_FINEOS_FRAMEWORK)),yes)
$(call intermediates-dir-for,APPS,fineos-res,,COMMON)/package-export.apk:$(call intermediates-dir-for,APPS,framework-res,,COMMON)/src/R.stamp 
endif
###FineOS end
...
###FineOS start
    ifeq ($(strip $(HQ_FINEOS_FRAMEWORK)),yes)
        ifneq ($(LOCAL_NO_FINEOSRES),true)
          framework_res_package_export += \
	      $(call intermediates-dir-for,APPS,fineos-res,,COMMON)/package-export.apk
        endif
    endif
###FineOS end      
